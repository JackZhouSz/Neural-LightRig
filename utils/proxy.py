...
# `no_proxy` is functional only if you manually set the flag, by which you intend to fetch data from private servers.
NO_PROXY = "NLR_NO_DATA_PROXY" in os.environ
